...
class ConfigPanel extends MovieClip
{
  ...
  /* PAPYRUS INTERFACE */
	...
	// When numbers are passed from Papyrus => SKSE => Scaleform, the signed int -1 is
	// incorrectly passed as 4294967295, 0xffffffff.
	public function intNegOneOrNumber(n: Number): Number {
		if(n == 4294967295)
			return -1;
		return n;
	}
	...
	public function setMenuDialogParams(a_startIndex: Number, a_defaultIndex: Number): Void
	{
		...
		var initObj = {
			...
			menuStartIndex: intNegOneOrNumber(a_startIndex),
			menuDefaultIndex: intNegOneOrNumber(a_defaultIndex)
		};
